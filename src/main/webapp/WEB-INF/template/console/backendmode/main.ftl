		...
		<tr>
			...
			<td class="navTd">
				<div id="nav" class="nav">
				 	 <ul>
	                    <li>
	                        <a href="#devcenter"  class="current">${message("admin.backendmode.managecenter")}</a>
	                    </li>
	                </ul>
	             </div>
	         </td>
			...
			<td class="menuTd">
				<div id="menu" class="menu">
					<dl id="guide" class="default">
		                ...
		                <dd>
		                    <a href="../backendmode/infoAdd.jhtml" class="current" target="iframe"><i></i>${message("admin.backendmode.managecenter")}</a>
		                </dd>
					</dl>
			</td>
			<td class="iframeTd">
				<iframe id="iframe" name="iframe" src="../backendmode/infoAdd.jhtml" frameborder="0" ></iframe>
			</td>
		</tr>
		<tr class="footer">
			<td colspan="2">
