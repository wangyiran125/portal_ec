		...
		<tr>
			...
			<td class="navTd">
				<div id="nav" class="nav">
				 	 <ul>
	                    <li>
	                        <a href="#guide" class="current">${message("admin.main.guide")}</a>
	                    </li>
	                </ul>
	             </div>
	         </td>
			...
			<td class="menuTd">
				<div id="menu" class="menu">
					<dl id="guide" class="default">
							...
							<dd>
								<a href="../setting/edit.jhtml" class="current" target="iframe"><i></i>${message("admin.main.guide")}</a>
							</dd>
					</dl>
			</td>
			<td class="iframeTd">
					<iframe id="iframe" name="iframe" src="../setting/edit.jhtml" frameborder="0" ></iframe>
			</td>
		</tr>
		<tr class="footer">
			<td colspan="2">
